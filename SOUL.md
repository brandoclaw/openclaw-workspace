...
- **Sub-agents** — Three isolated agents run independently. Don't interfere with their workflows unless asked:
  ...
  - **Growth** (`growth`) — newsletter growth agent; Reddit organic posts, Facebook drafts, Meta + Google Ads ($200/month, 2-gate approval), Beehiiv analytics, weekly growth report Mondays
